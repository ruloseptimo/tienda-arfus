...
exports.createProduct = async (req, res) => {
    try {
        const { name, description, price, stockQuantity } = req.body; // Obtiene los datos del producto desde el cuerpo de la solicitud.
        const newProduct = await Product.create({ name, description, price, stockQuantity }); // Crea un nuevo producto en la base de datos.
